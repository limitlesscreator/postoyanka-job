		...
		<div class="row visible-xs visible-sm">
			<div class="col-lg-4 col-sm-12 col-xs-12 text-main-page">
				<div class="text-block-main-page">
					...
					<h2><label>Бесплатный мастер-класс: Флюидарт</label></h2>
					<p><label>Каждый вторник в 19:00 и субботу в 16:00 <br>ведёт руководитель и основатель студии Кристина Сельдина</label>
					</p>
