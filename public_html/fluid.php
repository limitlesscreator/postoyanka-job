...
require __DIR__ . '/../fluidart/vendor/yiisoft/yii/framework/yii.php';

$base = require __DIR__ . '/../fluidart/protected/config/main.php';

$confManager = new yupe\components\ConfigManager();
$confManager->sentEnv(\yupe\components\ConfigManager::ENV_WEB);

require __DIR__ . '/../fluidart/vendor/autoload.php';
